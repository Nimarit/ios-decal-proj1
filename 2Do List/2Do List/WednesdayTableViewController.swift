...
class WednesdayTableViewController: UITableViewController {
    ...
    @IBAction func unwindAfterSaving(segue: UIStoryboardSegue) {
        ...
        if myAddItemVC.textField.text != nil {
            wednesdayModel.append(myAddItemVC.textField.text!)
    ...
    override func tableView(tableView: UITableView, commitEditingStyle editingStyle: UITableViewCellEditingStyle, forRowAtIndexPath indexPath: NSIndexPath) {
        if editingStyle == UITableViewCellEditingStyle.Delete {
            ...
            deleteItem = wednesdayModel[indexPath.row]
    ...
    func deleteItemAction(alertAction: UIAlertAction!) {
        if let indexPath = deleteItemIP {
            ...
            wednesdayModel.removeAtIndex(indexPath.row)
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        cell.textLabel?.text = wednesdayModel[indexPath.row]
